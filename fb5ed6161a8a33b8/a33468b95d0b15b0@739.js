// https://observablehq.com/@d3/color-legend@739
...
function Legend(color, options) {
  return legend({...options, color});
}
)});
  main.variable(observer("ramp")).define("ramp", function(){return(
function ramp(color, n = 256) {
  ...
  main.variable(observer("swatches")).define("swatches", ["htl","entity"], function(htl,entity){return(
function swatches({
  color,
  columns = null,
  format = x => x,
